  ...
  return (
    <div className="relative min-h-screen bg-slate-50 dark:bg-obsidian text-slate-800 dark:text-slate-200 font-sans selection:bg-sterile-cyan/30 selection:text-white transition-colors duration-500">
      ...
      <nav className={`
        ...
        ${scrolled 
          ? 'bg-white/95 dark:bg-obsidian/95 backdrop-blur-md border-slate-200 dark:border-slate-800 py-3 shadow-lg' 
        ...
        <div className="container mx-auto px-4 md:px-8 flex items-center justify-between">
          ...
          <div className="hidden xl:flex items-center gap-6">
            {NAV_LINKS.map(link => (
              <a 
                ...
                className="text-xs font-semibold text-slate-600 dark:text-slate-300 hover:text-amber-500 dark:hover:text-amber-400 transition-colors tracking-wide relative group cursor-pointer uppercase"
              >
                {link.label}
                <span className="absolute -bottom-1.5 left-1/2 -translate-x-1/2 w-0 h-[2px] bg-amber-500 group-hover:w-full transition-all duration-300" />
              </a>
            ))}
          </div>
          ...
          <div className="hidden lg:flex items-center gap-3">
            ...
            <button
              ...
              className="px-3.5 py-2 rounded-full bg-amber-500/10 hover:bg-amber-500/20 text-amber-600 dark:text-amber-400 border border-amber-500/30 text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer"
            >
            ...
            <button
              ...
              className="px-3.5 py-2 rounded-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs font-semibold transition-all flex items-center gap-1.5 border border-slate-200 dark:border-slate-700 cursor-pointer"
            >
              <FileText className="w-3.5 h-3.5 text-sterile-cyan" />
              <span>Sample Report</span>
            </button>

            {/* Google Profile Link Badge */}
            <a
              href={GOOGLE_PROFILE_URL}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-slate-100 dark:bg-slate-800/80 hover:bg-amber-500/10 text-slate-700 dark:text-slate-300 hover:text-amber-600 dark:hover:text-amber-400 border border-slate-200 dark:border-slate-700 text-xs font-semibold transition-all group"
            ...
            <button 
              onClick={toggleTheme}
              className="p-2 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:text-amber-500 transition-colors cursor-pointer"
            ...
            <button 
              ...
              className="px-4 py-2 bg-gradient-to-r from-amber-500 to-sterile-cyan hover:from-amber-600 hover:to-cyan-600 text-white font-bold text-xs rounded-full transition-all duration-300 shadow-md shadow-amber-500/20 flex items-center gap-1.5 cursor-pointer"
            >
          ...
          <div className="flex items-center gap-2 lg:hidden">
            <button
              onClick={() => setIsPrescriptionModalOpen(true)}
              className="px-2.5 py-1.5 rounded-full bg-amber-500/10 text-amber-600 dark:text-amber-400 border border-amber-500/30 text-xs font-bold flex items-center gap-1"
            >
              <UploadCloud className="w-3.5 h-3.5" />
              <span>Rx</span>
            </button>
